...
def startup2():
    ...
    if patch < 26:
        warning_text = "\n".join((
            "Pokemanki has been updated to support the newer versions of Anki (2.1.26+).",
            "If you are using an earlier version of Anki, please download the legacy version of the addon"
        ))
        showWarning(warning_text, title="Pokemanki won't function properly")
        return


gui_hooks.profile_did_open.append(startup2)
...
mw.alolanmenu = QMenu(_(version), mw)
